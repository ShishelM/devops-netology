...
1. В чём опасность применения ключа -auto-approve?
    ...
    Если в была допущена ошибка (например, опечатка в имени важного ресурса, которая ведет к его пересозданию, или случайное удаление базы данных), 
    Terraform выполнит это действие мгновенно (без аппрува).
